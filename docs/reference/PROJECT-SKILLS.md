...
## FoodLister-Specific Patterns#

### Component Patterns#
- **Server Components by default**: Use Server Components unless interactivity needed#
- **'use client' directive**: Only add when using hooks, browser APIs, or interactivity#
...
- **Array Types**: Leverage PostgreSQL arrays for multi-value fields#
- **Triggers**: Use for maintaining derived data (e.g., user_stats)#
