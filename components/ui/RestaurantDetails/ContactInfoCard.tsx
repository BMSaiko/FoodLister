          ...
          return (
            ...
            >
              ...
              <a
                ...
                className="ml-2 sm:ml-3 p-1 sm:p-2 hover:bg-[var(--amber-100)] rounded-full transition-colors group-hover:scale-110 transition-transform duration-200"
                title={`Ligar para ${phone}`}
              >
                <svg className="h-4 w-4 sm:h-5 w-5 text-[var(--amber-600)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
