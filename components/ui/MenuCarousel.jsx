      ...
      {images.length > visibleCount && (
        <div className="hidden sm:flex justify-end mb-4">
          <button
            ...
            className="flex items-center justify-center w-10 h-10 bg-white hover:bg-amber-50 border border-amber-200 text-amber-600 hover:text-amber-700 rounded-xl transition-all duration-200 shadow-sm hover:shadow-md"
