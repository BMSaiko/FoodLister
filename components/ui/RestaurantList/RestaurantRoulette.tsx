...
const RestaurantRoulette = () => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-3 sm:px-4 lg:px-6 pb-6 sm:pb-8 relative overflow-hidden">
      ...
      <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 mb-4 sm:mb-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-4 mb-4">
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 w-full sm:w-auto">
            <button
              ...
              className="flex items-center justify-center px-4 py-2.5 sm:py-2 bg-gradient-to-r from-[var(--amber-500)] to-[var(--orange-500)] text-white rounded-lg hover:from-[var(--amber-600)] hover:to-[var(--orange-600)] active:from-[var(--amber-700)] active:to-[var(--orange-700)] transition-all duration-200 min-h-[44px] font-medium shadow-md hover:shadow-lg transform hover:scale-[1.02] active:scale-[0.98]"
            >
        ...
        <div className="mt-4 pt-4 border-t border-[var(--gray-200)]">
          ...
          {availableCount > 0 ? (
            ...
            <p className="text-sm sm:text-base text-[var(--red-500)] font-medium">
        ...
        <div className="flex flex-col items-center relative z-10">
          <div className="relative w-full max-w-[320px] sm:max-w-[360px] md:max-w-[400px] aspect-square mb-4 sm:mb-6">
              ...
              <defs>
                ...
                {filteredRestaurants.map((_, i) => {
                  ...
                  const colors = [
                    ...
                    'var(--teal-500)',
                    'var(--cyan-500)',
                    'var(--amber-500)', // repetir para mais variações
                    'var(--orange-500)',
                    'var(--red-500)',
                    'var(--yellow-500)',
                    'var(--pink-500)',
                ...
                <radialGradient id="centerGradient" cx="50%" cy="50%" r="50%">
                  <stop offset="0%" stopColor="var(--amber-500)" stopOpacity="1" />
                  <stop offset="100%" stopColor="var(--orange-500)" stopOpacity="0.8" />
                </radialGradient>
              </defs>
            ...
            <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1 sm:-translate-y-2 z-10">
              <div className="w-0 h-0 border-l-[8px] sm:border-l-[12px] border-r-[8px] sm:border-r-[12px] border-t-[14px] sm:border-t-[20px] border-transparent border-t-[var(--amber-600)] drop-shadow-lg"></div>
            </div>
            ...
            <div className="absolute inset-0 flex items-center justify-center z-10 pointer-events-none">
              <div className={`bg-white rounded-full flex items-center justify-center shadow-lg border-2 sm:border-4 border-[var(--amber-500)] ${
                ...
                <ChefHat className={`text-[var(--amber-500)] ${
      ...
      {/* Resultado */}
      {selectedRestaurant && (
        <div ref={resultRef} className="bg-transparent rounded-xl p-4 sm:p-6 lg:p-8 border border-[var(--amber-100)]/50 relative overflow-hidden">
          {/* Elementos decorativos de fundo no resultado */}
          <div className="absolute inset-0 opacity-10 pointer-events-none">
            <div className="absolute top-4 left-4 w-3 h-3 bg-[var(--amber-400)] rounded-full animate-pulse"></div>
            <div className="absolute top-4 right-4 w-3 h-3 bg-[var(--orange-400)] rounded-full animate-bounce animation-delay-300"></div>
            <div className="absolute bottom-4 left-4 w-3 h-3 bg-[var(--red-400)] rounded-full animate-pulse animation-delay-600"></div>
            <div className="absolute bottom-4 right-4 w-3 h-3 bg-[var(--amber-500)] rounded-full animate-bounce animation-delay-900"></div>
          </div>
          ...
          <div className="flex justify-center items-center mb-5 sm:mb-6 px-2 sm:px-0">
            <div className="w-full max-w-md mx-auto min-w-0 bg-transparent rounded-xl p-2 sm:p-3 border border-[var(--amber-100)]/50">
              <RestaurantCard
                ...
                <div className="mt-3 sm:mt-4 flex-shrink-0">
                  ...
                  <div className="flex flex-wrap gap-1.5 sm:gap-2 max-h-20 sm:max-h-24 overflow-y-auto">
                    {selectedRestaurantsForRoulette.map(restaurant => (
                      <div
                        key={restaurant.id}
                        className="inline-flex items-center bg-[var(--amber-100)] text-[var(--amber-800)] px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm"
                      >
                        ...
                        <button
                          ...
                          className="ml-1 sm:ml-2 text-[var(--amber-600)] hover:text-[var(--amber-800)] flex-shrink-0"
                        >
                          <X className="h-3 w-3" />
                        </button>
                      </div>
