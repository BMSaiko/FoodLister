...
export async function GET(
  ...
  try {
    ...
    if (listRestaurants && listRestaurants.length > 0) {
      ...
      const listRestaurantColumns = `id, name, description, price_per_person, rating, review_count,
      ...
      const listRestaurantColumnsFallback = `id, name, description, price_per_person, rating, review_count,
          location, source_url, creator, menu_url, menu_links, menu_images,
