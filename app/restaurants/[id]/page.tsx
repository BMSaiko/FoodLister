      ...
      {loading ? (
        ...
        <>
          ...
          <HeroSection
            ...
            onEdit={(user && (userProfile?.is_admin || restaurant.creator_id === user.id)) ? () => window.location.href = `/restaurants/${id}/edit` : undefined}
            isOwner={!!(user && (userProfile?.is_admin || restaurant.creator_id === user.id))}
          />
